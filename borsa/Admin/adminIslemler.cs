...
namespace borsa
{
    class adminIslemler
    {
        ...
        public void dgwDoldur1(DataGridView dgw)
        {
           
        }
        public void bakiyeCek(string bakiye, string onayId)
        {
  
        }
        public void bakiyeYukle(string onayId, int toplam, string bekleyenTutar, string bakiye)
        {
          
        }
        public void bakiyeIslemBitir(string islemId)
        {
